...
namespace Domain_DrivenDesign.ConsoleApp.BenchMark;
...
public class BenchMarkService
{
    ...
    public void Equals()
    {
        ...
        Test1 test1 = new Test1() { Id = id };
        Test1 test2 = new Test1() { Id = id };
    ...
    public void IEquatable()
    {
        ...
        Test2 test1 = new Test2() { Id = id };
        Test2 test2 = new Test2() { Id = id };
